...
var MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/portfolio';
if (!MONGODB_URI) {
    throw new Error('Please define the MONGODB_URI environment variable inside .env');
}
// Hide credentials in logs
var sanitizedUri = MONGODB_URI.replace(/\/\/([^:]+):([^@]+)@/, '//***:***@');
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    e_1 = _b.sent();
                    cached.promise = null;
                    console.error('Failed to establish MongoDB connection:', e_1);
                    throw e_1;
